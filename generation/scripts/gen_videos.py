...
@click.command()
@click.option('--network', 'network_pkl', default='../inversion/pretrained/ffhqrebalanced512-128.pth', help='Network pickle filename', required=True)
@click.option('--latent_path', 'latent_path',default='./outputs/output.pt', required=True)
...
@click.option('--outdir', help='Output directory', default='./outputs', type=str, required=True, metavar='DIR')
